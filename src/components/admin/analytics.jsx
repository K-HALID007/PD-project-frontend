...
export default function AdminAnalytics() {
  ...
  const fetchAnalyticsData = useCallback(async () => {
    try {
      ...
      const analyticsResponse = await fetch('http://localhost:5000/api/admin/analytics/realtime', { headers });
      const analytics = await analyticsResponse.json();
      
      // Fetch revenue analytics
      const revenueResponse = await fetch('http://localhost:5000/api/admin/analytics/revenue', { headers });
