...
import { Search, Package, Mail, History } from 'lucide-react';
  ...
  const handleTrack = async (e) => {
    ...
    try {
      ...
      if (searchType === 'id') {
        ...
        data = await trackingService.getTrackingByEmail(email);
      }
      ...
      <div className="w-full max-w-2xl mx-auto px-4">
        <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-gray-100 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500">Enter your tracking ID or email to track your shipment</p>
          </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="relative flex-grow">
                ...
                <input
                  ...
                  value={searchType === 'id' ? trackingId : email}
                  onChange={(e) => searchType === 'id' ? setTrackingId(e.target.value) : setEmail(e.target.value)}
                  placeholder={searchType === 'id' ? 'Enter Tracking ID' : 'Enter Email Address'}
          ...
          {trackingData && (
            <div className="mt-8">
              {searchType === 'id' ? (
                ...
                <div className="space-y-4">
                  <h2 className="text-xl font-semibold text-gray-900 mb-6">Your Shipments</h2>
                  {trackingData.data.map((shipment) => (
                    <div key={shipment.trackingId} className="bg-gray-50 rounded-xl p-6 border border-gray-100">
